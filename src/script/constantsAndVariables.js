var   GAME_OVER = false;
const MAX_LOG = 10; 			// Number of maximum log entries
const DEBUG = true;				// Enables debug mode
const BOOKER_CATCH = true;
const COOLDOWNTIME_VIDEO = 60;	// Time in seconds when video gets cold
...
var variables = {
	...
	"videoID": 0,
	"coldVideos": 0,
	"cooldown": COOLDOWNTIME_VIDEO, // Controls cold videos (old videos which won't get watched) and the auto-save function
	"subscriber": 0,
	"extraSubs": 0,
	"health": 100,
	"foodUnlocked": 0,
...
var food_stats = [{
	...
	"name": "Eat Premium Food",
	"time": 600,
	"hp": 30,
	"message": "You ate some delicious Premium Food "
}];

// Times, HP and modifiers for different video types
var video_stats = [{
...
var events = [{
	...
	"text": "A strange company, whose name you can't even pronounce, approaches you and offers you a deal: over 10 videos you have to rate, better, than they are!", // TODO: Um... Not quite sure I understood this...
